...
ROE = """** اهلا بك عزيزي المستخدم في قائمة اوامر بيكثون 
...
اوامر فارات سورس بيكثون @PICTH0N""",
        buttons=[
...
async def varssett(event):
    await event.edit(
        """اهلا بك في قائمة اوامر سورس بيكثون هذه بعض المعلومات عن بيكثون:

- سورس بيكثون يمتلك اكثر من 100 أمر 
- بيكثون هو افضل سورس عربي يتميز بالحماية
...
* يمكنك الحصول على  كليشة جاهزة من هذه القناة @picthon4
ملاحظة : يمكنك استخدام الاوامر في اي دردشة او محادثة
اوامر فارات سورس بيكثون @PICTH0N""",
        buttons=[
            [Button.inline("رجوع", data="pmvars")],
